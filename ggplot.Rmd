...
ggplot: Using the *default settings* in **ggplot()**
...
## Cheat sheet
We are covering only a few of the many plot types that can be created with the **ggplot2** package.
